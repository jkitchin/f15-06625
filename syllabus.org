...
** COLLECTED assignment:ex-mol-change				 :assignment:
...
** COLLECTED assignment:ode-2	      :assignment:
   DEADLINE: <2015-09-21 Mon>
   :PROPERTIES:
   :CATEGORY: participation
   :POINTS:   1
...
** TODO assignment:mol-change-pfr     :assignment:
...
** TODO assignment:const-p-batch      :assignment:
...
** TODO assignment:pdrop-consultant   :assignment:
